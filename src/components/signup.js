        ...
        <section   style={{backgroundColor: '#9A616D'}}>
            ...
            <div class="form-row">
                <div class="col-md-4 mb-3">
                    ...
                    <input type="tel" id="phone" name="phonenumber" pattern="[0-9]{10}" class="form-control"  required/>
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="col-md-6 mb-1">
                    ...
                    <select class="custom-select" name = "fieldofinterest">
           ...
           <div class="mb-3">
                ...
                <textarea class="form-control" id="validationTextarea" placeholder="Required example textarea" name = "bio"
                    required></textarea>
            </div>
